...
- [GizmoSQL Arrow Flight SQL Server](https://github.com/gizmodata/gizmosql-public) - Uses [Arrow Flight SQL](https://arrow.apache.org/docs/format/FlightSql.html) to allow you to run DuckDB (or SQLite) as a remote RDBMS server with authentication and TLS support.
